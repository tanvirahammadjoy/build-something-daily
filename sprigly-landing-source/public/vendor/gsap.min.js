...
!(function (t, e) {
    ...
    function Db(e, r, i) {
        ...
        if (!p) {
            if (
                (',' === e.substr(-1) && (e = e.substr(0, e.length - 1)), Rt[e])
            )
                p = Rt[e];
            else if ('#' === e.charAt(0)) {
                if (
        ...
        qt =
            ...
            (Vt.totalTime = function totalTime(t, e) {
                ...
                if (r && r.smoothChildTiming && this._ts) {
                    for (
                        La(this, t), !r._dp || r.parent || Ma(r, this);
                        r && r.parent;
                    )
                        (r.parent._time !==
                            r._start +
    ...
    var Gt = (function (i) {
        function Timeline(t, e) {
            ...
            return (
                ...
                t.paused && r.paused(!0),
                t.scrollTrigger &&
                    Oa(_assertThisInitialized(r), t.scrollTrigger),
                r
            );
        }
        ...
        return (
            ...
            (Timeline.updateRoot = function updateRoot(t) {
                if (
                    (L._ts && (qa(L, Ja(t, L)), (f = It.frame)), It.frame >= vt)
                ) {
                    vt += Y.autoSleep || 120;
                    var e = L._first;
                    if (
    ...
    function cc(t, e, i, n, a, o) {
        ...
        if (
            ...
            ((i._pt = h =
                new we(i._pt, a, t, 0, 1, u.render, u, 0, u.priority)),
            i !== c)
        )
            for (
                ...
                if (
                    ((s = a.timeline =
                        new Gt({
                            ...
                            defaults: O || {},
                            targets:
                                C && 'nested' === C.data ? C.vars.targets : P,
                        })).kill(),
                    ...
                    for (o = 0; o < h; o++)
                        (((u = xa(r, Kt)).stagger = 0),
                            ...
                            (u.delay =
                                (+Qt(m, _assertThisInitialized(a), o, f, P) ||
                                    0) - a._delay),
                            !b &&
                                1 === h &&
                                u.delay &&
                ...
                if (d) {
                    if (
                        ...
                        if (((i = _), (l = this.timeline), this._repeat)) {
                            if (
                                ((s = d + this._rDelay), this._repeat < -1 && p)
                            )
                            ...
                            a !== o &&
                                ...
                                this._initted &&
                                ((this._lock = r = 1),
                                (this.render(la(s * a), !0).invalidate()._lock =
                                    0));
                        }
                        if (!this._initted) {
                        ...
                        if (this._rEase) {
                            ...
                            this.ratio = h =
                                ...
                                this._invScale *
                                    this._invEase(
                                        (i - this._invTime) * this._invRecip
                                    );
    ...
    var Ee = {
        ...
        defaults: function defaults(t) {
            return (
                t && t.ease && (t.ease = jt(t.ease, j.ease)),
                wa(j, t || {})
            );
        },
            ...
            return (
                ...
                m !== Or &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute('transform', '') || !le(Sd(t, mr))),
