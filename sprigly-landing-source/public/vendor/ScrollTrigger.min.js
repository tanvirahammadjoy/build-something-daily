    ...
    var k =
        ((Observer.prototype.init = function init(e) {
            ...
            ((this.target = o = J(o) || ke),
                ...
                (n = !1 !== n),
                (r =
                    r || parseFloat(Ce.getComputedStyle(Ee).lineHeight) || 22));
            var ee,
                te,
                re,
                ne,
        ...
        if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
            ...
            ((g = 'scroll' + n.d2),
                q(
                    ...
                    (T && 20 < S) ||
                        (!T &&
                            (u ? Math.max(He[g], qe[g]) : o.parentNode[g]) <=
                                S + 1)
                ),
                u &&
                    ((l = _t(a)),
        ...
        Pt = function _setState(e) {
            if (e) {
                var t,
                    ...
                    o = 0;
                for (
                    (e.t._gsap || Fe.core.getCache(e.t)).uncache = 1;
                    o < i;
                    o += 2
                )
                    ((r = e[o + 1]),
            ...
            ((ScrollTrigger.prototype.init = function init(P, O) {
                if (
                    ...
                    var A,
                        ...
                        o,
                        T = (P = pb(
                            ct(P) || Va(P) || P.nodeType ? { trigger: P } : P,
                            St
                        )).onUpdate,
                        C = P.toggleClass,
                        a = P.id,
                        ...
                        he =
                            P.horizontal ||
                            (P.containerAnimation && !1 !== P.horizontal)
                                ? Ne
                                : Xe,
                        ve = !k && 0 !== k,
                        be = J(P.scroller || Je),
                        ...
                        Se = me
                            ? 0
                            : parseFloat(nb(be)['border' + he.p2 + yt]) || 0,
                        Te = this,
                        Ce =
                            P.onRefreshInit &&
                            function () {
                    ...
                    if (
                        ...
                        ((Y = this.markerStart =
                            Eb('start', a, u, he, e, t, 0, de)),
                            (N = this.markerEnd =
                                Eb('end', a, u, he, e, t, 0, de)),
    ...
    function Dc(e) {
        ...
        return (
            ...
            (e.onPress = function () {
                ...
                var e = y;
                ((y = Ja(
                    ((Je.visualViewport && Je.visualViewport.scale) || 1) / x
                )),
                    a.pause(),
                    e !== y && wc(p, 1.01 < y || (!f && 'x')),
                    (c = m()),
