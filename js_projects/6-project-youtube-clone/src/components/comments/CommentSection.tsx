  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-1 text-sm text-neutral-200 leading-relaxed whitespace-pre-wrap">
          {comment.text}
        </p>
        ...
        {showReplyInput && onReplySubmit && (
          <form onSubmit={onReplySubmit} className="mt-3 flex gap-2">
            ...
            <button
              ...
              className="rounded-full bg-blue-600 px-4 text-sm font-medium text-white hover:bg-blue-500 disabled:opacity-50"
            >
              Reply
            </button>
          </form>
