    ...
    return (
      <main className="min-h-screen bg-gray-950 flex items-center justify-center">
        <div className="text-center max-w-sm px-4">
          ...
          <h2 className="text-white text-lg font-semibold mb-2">No subscriptions yet</h2>
          <p className="text-gray-400 text-sm">Subscribe to channels to see their latest videos here.</p>
          <a href="/" className="inline-block mt-6 px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-full transition">
            Discover videos
          </a>
        </div>
      </main>
  ...
  return (
    <main className="min-h-screen bg-gray-950">
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <h1 className="text-xl font-bold text-white mb-6">Latest from subscriptions</h1>
