...
export function LikeDislikeButtons({ videoId, initialLikes, initialDislikes, isLoggedIn }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      <button onClick={() => handleReact(true)} disabled={loading} className={reaction === true ? `${btnBase} bg-white text-gray-950` : `${btnBase} bg-gray-800 hover:bg-gray-700 text-white`}>
      ...
      <button onClick={() => handleReact(false)} disabled={loading} className={reaction === false ? `${btnBase} bg-white text-gray-950` : `${btnBase} bg-gray-800 hover:bg-gray-700 text-white`}>
