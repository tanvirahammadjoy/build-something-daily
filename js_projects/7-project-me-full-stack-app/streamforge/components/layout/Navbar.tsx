                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                    {session ? (
                        <>
                            <Link
                                href="/upload"
                                className="hidden sm:flex items-center gap-2 px-4 py-1.5 bg-gray-800 hover:bg-gray-700 text-white text-sm rounded-full transition"
                            >
                                <svg
                                    className="w-4 h-4"
                                    fill="none"
                            ...
                            <Link
                                href={`/channel/${session.user.channelHandle ?? session.user.id}`}
                                className="w-8 h-8 rounded-full overflow-hidden bg-gray-700 flex-shrink-0"
                            >
                                {session.user.image ? (
                                    <Image
                        ...
                        <Link
                            href="/sign-in"
                            className="px-4 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-full transition"
                        >
                            Sign in
                        </Link>
                    )}
