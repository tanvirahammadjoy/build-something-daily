        ...
        <main className="min-h-screen bg-ink">
            <div className="max-w-5xl mx-auto px-4 py-8">
                ...
                <div className="mt-4 flex items-start justify-between gap-4 flex-wrap">
                    <h1 className="text-xl font-semibold text-paper flex-1 min-w-0">
                        {video.title}
                    </h1>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-paper-faint text-xs">
                                {video.user._count.subscribers.toLocaleString()}{' '}
                                subscribers
                            </p>
                        </div>
                    </Link>
                ...
                <div className="mt-4 bg-ink-surface rounded-xl p-4">
                    ...
                    {video.description && (
                        <p className="text-paper-dim text-sm mt-2 whitespace-pre-wrap">
                            {video.description}
                        </p>
                    )}
                    {video.tags.length > 0 && (
                        <div className="flex flex-wrap gap-2 mt-3">
                            {video.tags.map((t) => (
                                <Link
                                    ...
                                    className="text-flare text-xs hover:text-flare-dim"
                                >
                                    #{t.name}
                                </Link>
                            ))}
