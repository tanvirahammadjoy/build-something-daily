    ...
    <div className="min-h-screen flex items-center justify-center bg-ink px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          <h1 className="font-display text-2xl font-bold text-paper mb-2">Create your account</h1>
          <p className="text-paper-faint text-sm mb-8">Start uploading and watching on StreamForge</p>
          ...
          <p className="mt-6 text-center text-sm text-paper-faint">
            ...
            <Link href="/sign-in" className="text-flare hover:text-flare-dim">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
