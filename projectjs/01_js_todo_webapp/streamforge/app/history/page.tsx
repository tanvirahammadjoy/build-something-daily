    ...
    return (
      <main className="min-h-screen bg-ink flex items-center justify-center">
        <div className="text-center">
          <p className="text-paper-faint text-lg font-medium mb-2">No watch history yet</p>
          <p className="text-paper-faint/70 text-sm">Videos you watch will appear here.</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-ink">
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <h1 className="text-xl font-bold text-paper mb-6">Watch history</h1>
        {Object.entries(grouped).map(([label, videos]) => (
          <div key={label} className="mb-8">
            <h2 className="text-paper-faint text-sm font-medium mb-4 uppercase tracking-wide">{label}</h2>
