    ...
    <main className="min-h-screen bg-ink">
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-paper">Watch later</h1>
            <p className="text-paper-faint text-sm mt-1">{videos.length} video{videos.length !== 1 ? "s" : ""}</p>
          </div>
        </div>

        {videos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-paper-faint">
            <svg className="w-16 h-16 mb-4 text-ink-borderStrong" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-lg font-medium text-paper-faint mb-2">Nothing saved yet</p>
