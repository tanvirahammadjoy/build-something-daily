        ...
        <header className="sticky top-0 z-50 border-b border-ink-border bg-ink/90 backdrop-blur-sm">
            <div className="max-w-screen-xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
                ...
                >
                    ...
                    <span className="font-display font-bold text-lg text-paper hidden sm:block tracking-tight">
                        StreamForge
                    </span>
                </Link>
                ...
                <form action="/search" method="get" className="flex-1 max-w-xl">
                    <div className="flex">
                        ...
                        <button
                            aria-label="Search"
                            type="submit"
                            className="px-4 py-2 bg-ink-raised hover:bg-ink-border border border-l-0 border-ink-border rounded-r-full text-paper-dim transition"
                        >
                            <svg
                                className="w-4 h-4"
                                fill="none"
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                    {session ? (
                        <>
                            <Link
                                href="/upload"
                                className="hidden sm:flex items-center gap-2 px-4 py-1.5 bg-ink-raised hover:bg-ink-border text-paper text-sm rounded-full transition"
                            >
                                <svg
                                    className="w-4 h-4"
                                    fill="none"
                            ...
                            <Link
                                href="/subscriptions"
                                className="text-paper-dim hover:text-paper transition p-1.5 rounded-lg hover:bg-ink-raised"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="none"
